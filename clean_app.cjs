...
// Find the last valid occurrence of 'const handleMixAttributes = useCallback'
// Wait, we can just replace everything between 'const handleMixAttributes = useCallback'
// and 'const handleTogglePart = (id: string) => {'

const start = code.indexOf('  const handleMixAttributes = useCallback');
const end = code.indexOf('  const handleTogglePart = (id: string) => {');
